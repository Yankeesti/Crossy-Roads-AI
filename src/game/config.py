...
MAX_OBSTACLES = 3 #the maximum amount of obstacles that can be placed on a road section
MAX_CAR_SPEED = 0.075 #the maximum speed of the cars on the road section

DYNAMIC_SECTION_IN_A_ROW = [0,1,2,3,4] #Lists represents the possible amount of dynamic road sections that are placed in a row
DYNAMIC_SECTION_IN_A_ROW_PROB = [0.1,0.3,0.25,0.2,0.15] #Lists represents the probability of the amount of dynamic road sections that are placed in a row
